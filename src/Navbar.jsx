          ...
          <div className="flex justify-between items-center px-5 md:px-10 py-4 w-full">
            ...
            <div className="hidden md:flex space-x-10 items-center">
              ...
              <div className="group relative">
                <button className="text-xl text-[#003334] font-serif hover:text-[#ED1C22]">
                  Apply
                </button>
                <div className="absolute right-0 top-full mt-2 bg-[#EDEDED] border rounded-md shadow-md w-56 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-100 z-50">
                  <Link to="/create-account" className="block px-4 py-2 hover:bg-gray-500 text-[#003334] font-serif hover:text-[#ED1C22]">Create Account</Link>
